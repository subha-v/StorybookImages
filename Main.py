...
if __name__ == "__main__":
    ...
    outputDictionary = simpledialog.askstring(title="Test",
                                    prompt = "What is your image storage filepath?: ")
    # check it out
    ...
    image_recognition = extractImagesFromFile(first_image_filepath, outputDictionary)
